...
public class RunTimePolymorphismBankAccounts {
	public static void main(String[] args) {
		...
		BankAccount account3 = new FixedDepositAccount(10000,1,1);
		...
		if (account3 instanceof FixedDepositAccount) {
			System.out.println("FD account: ");
			//account3.printMaturityDetails();
			FixedDepositAccount fixedDepositAccount = (FixedDepositAccount) account3;
			fixedDepositAccount.printMaturityDetails();
		}
