...
//private class PrivateClassExample { // this will give error as the main class should always be public/abstract/final
	...
	public static void main(String[] args) {
		...
		PrivateInnerClass inner = outer.new PrivateInnerClass(); // Accessing private inner class within the same
																	// enclosing class
	}
}
...
class AnotherClass {
	public static void main(String[] args) {
		PrivateClassExample outer = new PrivateClassExample();
		// PrivateInnerClass inner = outer.new PrivateInnerClass(); // Compilation error
		// - PrivateInnerClass is not accessible here
	}
}