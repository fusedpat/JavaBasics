...
import com.mycompany.learnjava.encapsulation.User;
...
public class ArrayVsArrayList {
    public static void main(String[] args) {
       ...
       //  numbers[5] = 40;
        ...
        User user1 = new User("x", "xpassword");
        User user2 = new User("y", "ypassword");
        
        userList.add(user1);
        userList.add(user2);
        
        for (User userToPrint : userList) {
            System.out.println(userToPrint.getUsername());
            System.out.println(userToPrint.getPassword());
        }
